...
namespace DSN {
    class MicrosoftSpeechRecognition : NAudio.CoreAudioApi.Interfaces.IMMNotificationClient, ISpeechRecognitionManager {
        ...
        public MicrosoftSpeechRecognition(Configuration config) {
            ...
            Trace.TraceInformation("Speech Recognition Engine: Microsoft");
